<style src="./Loader.scss" module lang="scss"></style>
<script src="./Loader.js"></script>

<template>
  <div :class="[$style.loader]" @click="startAnimation" ref="loader">
    <h2 :class="['heading-02', $style.title]" ref="title">Calculating <br>
      travel plan
    </h2>

    <div class="splash">
      <div class="anim" ref="planeWrap">
        <div class="loader">
